                                        ...
                                        <div class="form-group mb-2">
                                            <div class="">
                                                ...
                                                <select class="form-select rounded-0 @error('usaha') is-invalid @enderror"
                                                    ...
                                                    <option value="perdagangan"
                                                        {{ old('usaha') == 'perdagangan' ? 'selected' : '' }}>
                                                        Perdagangan
                                                    </option>
                                                    <option value="pertanian"
                                                        {{ old('usaha') == 'pertanian' ? 'selected' : '' }}>
                                                        Pertanian
                                                    </option>
                                            ...
                                            <div class="mt-1" id="usaha-lainnya-div"
                                                ...
                                                <input type="text" id="usaha_lainnya" name="usaha_lainnya"
                                                    ...
                                                    placeholder="sebutkan usaha lainnya"
                                                    value="{{ old('usaha_lainnya') }}">
                                                @error('usaha_lainnya')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <select class="form-select rounded-0 @error('tipe_angsuran') is-invalid @enderror"
                                            ...
                                            <option value="bulanan"
                                                {{ old('tipe_angsuran') == 'bulanan' ? 'selected' : '' }}>
                                                Tiap Bulan
                                            </option>
                                            <option value="sekaligus"
                                                {{ old('tipe_angsuran') == 'sekaligus' ? 'selected' : '' }}>
                                                Sekaligus
                                            </option>
                                        </select>
                                        @error('tipe_angsuran')
