...
class KeuanganArusController extends Controller
{
    public function index()
    {
        ...
        return view('anggota.bendahara.keuangan-arus.index', compact('aruses'));
    }

    public function create_pemasukan()
    {
        $rekenings = Rekening::where('is_aktif', true)
            ->select(
                'id',
                'jenis',
                'bank',
    ...
    {
        return view('anggota.bendahara.keuangan-arus.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('anggota/bendahara/keuangan-arus')->with('success', 'Berhasil menambahkan Rekening');
    }
