...
class PinjamanController extends Controller
{
    public function index()
    {
        ...
        return view('anggota.bendahara.pinjaman.index', compact('pinjamans'));
    }
    ...
    public function show($id)
    {
        ...
        return view('anggota.bendahara.pinjaman.show', compact(
            'pinjaman',
            'user',
            'user_detail',
            'pinjaman_analis',
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('anggota/bendahara/pinjaman')->with('success', 'Hasil analisis pinjaman berhasil dikirim');
    }
    ...
    public function print($id)
    {
        ...
        $pdf = Pdf::loadview('anggota.bendahara.pinjaman.print', compact('pinjaman', 'dana_terbilang', 'user', 'user_detail'));
